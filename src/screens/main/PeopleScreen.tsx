...
export const PeopleScreen: React.FC<{ navigation: any }> = () => {
  ...
  const [residents, setResidents] = useState<Resident[]>(initialSocietyData.residents);
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.directoryList}>
          {filteredResidents.map((r) => (
            <View key={r.id} style={styles.flatCard}>
              ...
              <View style={styles.cardHeaderRow}>
                <View>
                  ...
                  <Text style={styles.ownerText}>Owner: {r.ownerName}</Text>
                </View>
              ...
              {r.status !== 'Vacant' ? (
                <View style={styles.residentBox}>
                  <View style={styles.avatarWrapper}>
                    {r.avatarUrl ? (
                      <Image source={{ uri: r.avatarUrl }} style={styles.residentAvatar} />
                    ) : (
                  ...
                  <View style={styles.residentTextCol}>
                    <Text style={styles.residentLabel}>
                      Current Resident {r.isSelfOwner ? '(Self)' : ''}
                    </Text>

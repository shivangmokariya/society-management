    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.greetingSection}>
          <Text style={styles.greetingTitle}>Good morning, {data.secretaryName}</Text>
          <Text style={styles.greetingSubtitle}>Here's what's happening in {data.name} today.</Text>
        </View>
        ...
        <View style={styles.sectionGap}>
          <View style={styles.statGrid}>
            ...
            <StatCard
              label="Pending Dues"
              value={`${data.pendingDuesFlats} Flats`}
        ...
        <View style={styles.sectionGap}>
          <FinancialProgressChart
            percentage={data.financialProgressPercent}
            targetText={`${data.monthlyIncome} of ${data.monthlyIncomeTarget} target`}
          />
        </View>
        ...
        <View style={styles.sectionGap}>
          <View style={styles.sectionHeader}>
            ...
            <View style={styles.badgeCount}>
              <Text style={styles.badgeCountText}>3 Tasks</Text>
            </View>
          </View>

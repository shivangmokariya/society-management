    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.balanceHeader}>
          ...
          <Text style={styles.balanceAmount}>{data.detailedBalance}</Text>
          <View style={styles.trendBadge}>
            <MaterialIcons name="trending-up" size={16} color={colors.primary} />
            <Text style={styles.trendText}>{data.balanceTrend}</Text>
          </View>
        </View>
        ...
        <View style={styles.summaryRow}>
          <View style={styles.inflowCard}>
            ...
            <Text style={styles.flowAmount}>{data.totalInflow}</Text>
          </View>
          ...
          <View style={styles.outflowCard}>
            ...
            <Text style={styles.flowAmount}>{data.totalOutflow}</Text>
          </View>
        </View>
          ...
          <View style={styles.approvalCard}>
            ...
            <View style={styles.approvalContent}>
              <Text style={styles.approvalTitle}>
                Approval Needed ({data.pendingApprovalsCount})
              </Text>
              <Text style={styles.approvalDesc}>
                {data.pendingApprovalItem.title} • {data.pendingApprovalItem.amount}
              </Text>
        ...
        <View style={styles.sectionGap}>
          ...
          <ExpenseBreakdownBar categories={data.majorExpenses} />
        </View>

...
export const LoginScreen: React.FC<LoginScreenProps> = ({ navigation }) => {
  const [email, setEmail] = useState('secretary@greenview.com');
  const [password, setPassword] = useState('password123');
  const [showPassword, setShowPassword] = useState(false);
  const [rememberMe, setRememberMe] = useState(true);

  const handleLogin = () => {
    // Navigate into main app stack
    navigation.reset({
      index: 0,
      routes: [{ name: 'MainApp' }],
    });
        ...
        <View style={styles.card}>
          ...
          <View style={styles.headerBox}>
            <View style={styles.logoWrapper}>
              <Image
                source={{ uri: initialSocietyData.loginCardLogoUrl }}
          ...
          <View style={styles.form}>
            ...
            {/* Sign In Button */}
            <TouchableOpacity style={styles.signInBtn} activeOpacity={0.8} onPress={handleLogin}>
